...
pessoa.apresentacao = function(){
        ...
        else if ( pessoa.metrosCaminhados === 0 ){
            return "Olá, eu sou a " + pessoa.nomeCompleto + " tenho " + pessoa.idade + "anos" + "," + pessoa.altura + ", meu peso é" + pessoa.peso + " e eu ainda nao caminhei hoje ";
        }
        else{
